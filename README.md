...
copy of a small site, an ESP32-C3 plugged into the controller port asks it
for pages, and a bridge on a host machine turns that into HTTP you can open
in a browser.
...
exactly as they will run on hardware.
...
- An ESP32-C3 SuperMini on the controller port through a level shifter.
  Pinout is in [`docs/running.md`](docs/running.md).
